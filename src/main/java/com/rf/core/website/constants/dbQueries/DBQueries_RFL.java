...
public class DBQueries_RFL {
	...
	public static String GET_RANDOM_EXISTING_CONSULTANT_SITE_URL = 
			"SELECT TOP 1 "+
					...
					"ORDER BY NEWID()";
	public static String GET_RANDOM_INACTIVE_CONSULTANT_EMAILID = "select top 1 * from dbo.Accounts where AccountTypeID='1' AND Active='0' and EmailAddress not like 'terminate_%' order by NEWID()";
