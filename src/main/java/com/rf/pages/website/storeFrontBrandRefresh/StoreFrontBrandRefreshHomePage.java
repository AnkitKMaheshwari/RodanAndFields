...
public class StoreFrontBrandRefreshHomePage extends StoreFrontBrandRefreshWebsiteBasePage{
	...
	private static final By COUNTRY_TOGGLE_LOC=By.xpath("//div[contains(@id,'CountryFlags')]/descendant::a[1]");
	private static final By DONATION_PRODUCT_LOC=By.xpath("//a[contains(text(),'Prescription For Change Donation')]/following::a[1]");
	...
	private static final By ERROR_MSG_FOR_INVALID_CC = By.xpath("//*[contains(text(),'transaction has been declined')]");
	...
	private static final By TAX_ON_ORDER_CONFIRMATION_PAGE_LOC=By.xpath("//span[contains(@id,'uxTax')]");
	...
	private static final By RODAN_AND_FIELDS_IMG_LOC = By.xpath("//div[contains(@id,'logo')]//img");
	...
	private static final By CHECK_MY_PULSE_LOC=By.xpath("//a[contains(text(),'Check My Pulse')]"); 
	...
	private static final By COMPENSATION_PLAN_LINK=By.xpath(".//*[@id='RFContent']//a[contains(text(),'Compensation Plan here')]");
	...
	private static final By SOLUTION_TOOL_HOME_PAGE_LINK_LOC=By.xpath("//a[contains(text(),'Get Started')]");
	...
	private static String addToBagButtonForProductNumberLoc = "//div[@id='FullPageItemList']/div[%s]//span[contains(text(),'Add to Bag')]";
	...
	public void clickCompleteAccountNextBtn(){
		...
		driver.click(COMPLETE_ACCOUNT_NEXT_BTN_LOC);
	...
	public void clickTermsAndConditions(){
		...
		//driver.quickWaitForElementPresent(EMAIL_POLICY_AND_PROCEDURE_TOGGLE_BTN_LOC);
		driver.scrollToElement(RFWebsiteDriver.driver, driver.findElement(EMAIL_POLICY_AND_PROCEDURE_TOGGLE_BTN_LOC));
		driver.click(EMAIL_POLICY_AND_PROCEDURE_TOGGLE_BTN_LOC);
		...
		driver.pauseExecutionFor(2000);
		driver.click(ENROLL_E_SIGN_CONSENT_TOGGLE_BTN_LOC);
	...
	public void chargeMyCardAndEnrollMe(){
		...
		driver.waitForElementToBeClickable(CONFIRM_AUTOSHIP_BTN_LOC, 10);
		driver.pauseExecutionFor(2000);
	...
	public void clickAddToCartBtn(){		
		driver.click(By.xpath("//*[@id='FullPageItemList']/descendant::a[contains(@class,'addcart')][1]")); 
	...
	public StoreFrontBrandRefreshRCUserPage loginAsRCUser(String username,String password){
		...
		driver.waitForPageLoad();
		acceptPoliciesAndProcedures();
		return new StoreFrontBrandRefreshRCUserPage(driver);
	}
	...
	public boolean isLoginButtonPresent(){
		driver.waitForElementPresent(By.id("loginButton"),50);
		return driver.isElementPresent(By.id("loginButton"));
	}

	public void clickEditMyPhotoLink(){
		driver.waitForElementPresent(EDIT_MY_PHOTO_LINK,20);
	...
	public boolean isUploadANewPhotoButtonPresent(){
		driver.waitForElementPresent(UPLAOD_A_NEW_PHOTO_BTN,10);
	...
	public void acceptPoliciesAndProcedures(){
		boolean isModalPresent = driver.isElementPresent(By.xpath("//div[@class='ModalNotice']//a[@id='uxContinue']"));
		if(isModalPresent){
	...
	public void clickCareersLink(){
		driver.quickWaitForElementPresent(CAREERS_LINK_LOC);
		driver.click(CAREERS_LINK_LOC);
		logger.info("Careers Link clicked");
		driver.waitForPageLoad();
	}

	public StoreFrontBrandRefreshPulsePage clickCheckMyPulse() {
		driver.click(CHECK_MY_PULSE_LOC);
		return new StoreFrontBrandRefreshPulsePage(driver);
	}
	...
	public void clickOnRodanAndFieldsLogo(){
		try{
			...
			driver.findElement(By.xpath("//div[@id='Logo']//img")).click();
			driver.pauseExecutionFor(5000);
			//			driver.clickByJS(RFWebsiteDriver.driver,By.xpath("//div[@id='Logo']//img"));			
		}catch(Exception e){
	...
	public void chooseShippingMethod(String methodName) {
		driver.click(By.xpath(String.format(CHOOSE_SHIPPING_METHOD_lOC, methodName)));
		logger.info("shipping method clicked");
	}
	...
	public void clickBottomPageCategoryLink(String categoryName) {
		driver.click(By.xpath(String.format(RF_CONNECTION_LINK_LOC, categoryName)));
		logger.info("Clicked on "+categoryName);
	}

	public boolean isRFConnectionPageHeaderVisible() {
		return driver.isElementVisible(RF_CONNECTION_PAGE_HEADER_LOC);
	}

	public boolean isDERMRFPageHeaderVisible() {
		return driver.isElementVisible(DERM_RF_PAGE_HEADER_LOC);
	}
	...
	public void clickSolutionToolHomePage() {
		driver.click(SOLUTION_TOOL_HOME_PAGE_LINK_LOC);
		logger.info("Solution tool get started link clicked");
		driver.waitForPageLoad();
	}
	...
	public void clickBusinessPresentationEventsCalendarLink() {
		driver.click(BUSINESS_PRESENTATION_EVENT_CALENDAR_LINK_LOC);
		logger.info("Compansation plan link clicked");
		driver.waitForPageLoad();
	}
	...
	public void clickOnReadTheirInspiringStoriesLink() {
		driver.quickWaitForElementPresent(READ_THEIR_INSPIRING_STORIES_LINK_LOC);
		driver.click(READ_THEIR_INSPIRING_STORIES_LINK_LOC);
		logger.info("Read their inspiring stories clicked");
		Set<String> set=driver.getWindowHandles();
		Iterator<String> it=set.iterator();
		String parentWindow=it.next();
		String childWindow=it.next();
	...
	public void clickEnrollNowBtnOnMeetOurCommunityPage() {
		driver.quickWaitForElementPresent(ENROLL_NOW_MEET_OUR_COMMUNITY_PAGE_LOC);
		driver.click(ENROLL_NOW_MEET_OUR_COMMUNITY_PAGE_LOC);
		logger.info("Enroll now button on meet our community page clicked");

	}

	public void clickLinksOnMeetourCommunityPage(String linkName) {
		...
		logger.info("Clicked on "+linkName);
		Set<String> set=driver.getWindowHandles();
		Iterator<String> it=set.iterator();
		String parentWindow=it.next();
		String childWindow=it.next();
	...
	public void selectCountry(String countryName) {
		driver.click(By.xpath(String.format(countryLoc, countryName)));
		logger.info("Country selected is: "+countryName);
	}

	public boolean isCountryPresentInCountryToggle(String countryName) {
		driver.waitForElementToBeVisible(By.xpath(String.format(countryLoc, countryName)), 10000);
		return driver.isElementVisible(By.xpath(String.format(countryLoc, countryName)));
	}
	...
	public boolean isYouMayAlsoFindTheseProductsSectionVisible() {
		...
		for(int i =1;i<=10;i++ ){
			...
			try{
				...
				driver.isElementVisible(By.xpath(".//*[@class='slick-track']//div[1]"));
	...
	public String selectProductFromCarouselcorp() {
		String prodname=driver.getText(By.xpath(".//*[@class='slick-track']//div[3]//span/a")).toLowerCase();
		logger.info(prodname);		
		driver.click(By.xpath(".//*[@class='slick-track']/div[3]//img"));
		logger.info("Carousel product clicked");
		driver.pauseExecutionFor(2000);
		return prodname;
	}
	...
	public String selectProductFromCarousel() {
		...
		driver.click(By.xpath(".//*[@class='slick-track']/div[1]//img"));
		logger.info("Carousel product clicked");
		driver.pauseExecutionFor(2000);
		return prodname1;
	}
