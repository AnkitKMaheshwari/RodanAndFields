...
public class StoreFrontBrandRefreshPCUserPage extends StoreFrontBrandRefreshWebsiteBasePage{
	...
	public void clickDelayPCPerksLink(){
		driver.waitForElementPresent(DELAY_NEXT_SHIP_DATE_LINK);
		driver.click(DELAY_NEXT_SHIP_DATE_LINK);
		logger.info("Delay PC perks link clicked");
	}


	public void clickCancelPCPerksLink(){
		driver.waitForElementPresent(CANCEL_PC_PERKS_LINK);
		driver.click(CANCEL_PC_PERKS_LINK);
		logger.info("Cancel PC perks link clicked");
	}
	...
	public void clickGoToRFHomeButton(){
		driver.click(By.xpath("//a[@id='BtnGoHome']"));
		logger.info("Clicked on Go to R+F Home Button");
	}
