...
public class CSCockpitRFWebsiteBasePage extends RFBasePage{
	...
	private static final By ADDRESS_LINE_TEXT_BOX = By.xpath("//span[text()='Line 1' or text()='Address 1']/following::input[1]");
	...
	public void clickCustomerTab(){
		...
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(CUSTOMER_TAB));
		driver.waitForCSCockpitLoadingImageToDisappear();
	}
