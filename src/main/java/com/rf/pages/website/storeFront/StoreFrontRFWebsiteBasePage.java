...
public class StoreFrontRFWebsiteBasePage extends RFBasePage{
	...
	private final By WELCOME_DD_EDIT_CRP_LINK_LOC = By.xpath("//div[@id='account-info-button']//a[contains(text(),'Edit CRP')]");
	...
	private final By LOGIN_LINK_AU_LOC = By.xpath("//div[@class='login-block']");
	private final By USERNAME_TXTFLD_AU_LOC = By.id("emailAddress");
	private final By PASSWORD_TXTFLD_AU_LOC = By.id("password");
	private final By LOGIN_BTN_AU_LOC = By.id("login");
	...
	public String selectProductAndProceedToBuy(){
		applyPriceFilterHighToLow();
		String productName = null;
		String addToBagButton = "//div[@id='main-content']/descendant::button[contains(text(),'ADD TO BAG')]";
		String addToBagButtonOfFirstProduct=addToBagButton+"[1]";
		String addToBagButtonOfSecondProduct=addToBagButton+"[2]";
		driver.waitForElementPresent(By.xpath(addToBagButtonOfFirstProduct));
		if(driver.findElement(By.xpath(addToBagButtonOfFirstProduct)).isEnabled()==true){
			productName = driver.findElement(By.xpath(addToBagButtonOfFirstProduct+"/preceding::a[1]")).getText();
			driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath(addToBagButton)),"first product");
		}
		else{
			productName = driver.findElement(By.xpath(addToBagButtonOfSecondProduct+"/preceding::a[1]")).getText();
			driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath(addToBagButtonOfSecondProduct)),"second product");
		}
		driver.waitForLoadingImageToDisappear();
		driver.waitForPageLoad();
		logger.info("Product added to cart is "+productName);
		return productName;
	}

	public String selectProductForCRPAndProceedToBuy(){
		applyPriceFilterHighToLow();
		String productName = null;
		String addToBagButton = "//div[@id='main-content']/descendant::button[contains(text(),'ADD TO CRP')]";
		String addToBagButtonOfFirstProduct=addToBagButton+"[1]";
		String addToBagButtonOfSecondProduct=addToBagButton+"[2]";
	...
	public Boolean isCRPButtonPresentOnProductsPage(){
		String addToCRPButton = "//div[@id='main-content']/descendant::button[contains(text(),'ADD TO CRP')]";
		String addToCRPButtonOfFirstProduct=addToCRPButton+"[1]";
	...
	/**
	 * This method will click on the Add to CRP button of the first product
	 * @return added product name
	 * 
	 */
	public String selectProductAndProceedToAddToCRP(){
		String productAddToCRPBtnLoc ="//div[@id='main-content']/descendant::*[contains(text(),'ADD TO CRP') or @value='Add to crp'][1]";
		String productName= driver.getText(By.xpath(productAddToCRPBtnLoc+"/preceding::a[1]"));
		driver.waitForElementPresent(By.xpath(productAddToCRPBtnLoc));
		driver.click(By.xpath(productAddToCRPBtnLoc),"Add To CRP button");
		clickOnOKBtn();	
		driver.waitForLoadingImageToDisappear();
		driver.pauseExecutionFor(1000);
		retryClick(By.xpath(productAddToCRPBtnLoc),"Add To CRP button");
		return productName;
	}
	...
	public void enterNewRCDetails(String firstName,String lastName,String emailAddress,String password) throws InterruptedException{
		...
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//*[@id='next-button']")),"Create New Account button");
		driver.waitForLoadingImageToDisappear();
	}
	...
	public void enterNewPCDetails(String firstName,String lastName,String emailAddress,String password) throws InterruptedException{
		...
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//input[@id='become-pc']/..")),"Become PC checkbox");  
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//input[@id='next-button']")),"Create New Account button");
		driver.waitForLoadingImageToDisappear();
	}
	...
	public void enterMainAccountInfo(){
		...
		if(driver.getCountry().equalsIgnoreCase("CA")){
			...
			driver.type(By.id("address.line1"),TestConstants.ADDRESS_LINE_1_AU);
			logger.info("Address line 1 entered is "+TestConstants.ADDRESS_LINE_1_AU);
			driver.type(By.id("address.townCity"),TestConstants.CITY_AU);
			logger.info("City entered is "+TestConstants.CITY_AU);
			driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//form[@id='addressForm']//select[@id='state']")));
			//driver.click(By.xpath("//form[@id='addressForm']//select[@id='state']"));
			//			driver.waitForElementPresent(By.xpath("//form[@id='addressForm']//select[@id='state']/option[2]"));
			driver.click(By.xpath("//form[@id='addressForm']//select[@id='state']/option[2]"));
			logger.info("state selected");
			driver.type(By.id("address.postcode"),TestConstants.POSTAL_CODE_AU);
			logger.info("postal code entered is "+TestConstants.POSTAL_CODE_AU);
			driver.type(By.id("address.phonenumber"),TestConstants.PHONE_NUMBER_AU);
			logger.info("phone number entered is "+TestConstants.PHONE_NUMBER_AU);
		}
	...
	public void clickOnContinueWithoutSponsorLink() throws InterruptedException{
		driver.click(By.id("continue-no-sponsor"),"continue without sponsor link");	
		driver.waitForLoadingImageToDisappear();
	}
	...
	public void clickOnShippingAddressNextStepBtn() throws InterruptedException{
		...
		retryClick(By.id("saveShippingInfo"), "Shipping Addres Next Button");
		driver.pauseExecutionFor(5000);// don't remove this wait		
	}

	public void enterNewBillingCardNumber(String cardNumber){
		driver.waitForElementToBeVisible(By.id("card-nr"), 20);
	...
	public void clickOnSaveBillingProfile(){
		  ...
		  driver.pauseExecutionFor(2000);
		  if(driver.isElementPresent(By.id("submitButton"))) {
		   driver.click(By.id("submitButton"));
		  }
		  driver.waitForLoadingImageToAppear();
		  driver.pauseExecutionFor(10000); //is required
		  driver.waitForLoadingImageToDisappear();
		  driver.pauseExecutionFor(5000); //is required
		  //  retryClick(By.id("submitButton"), "Save Billing button");
	 }
	...
	public void clickOnBillingNextStepBtn() throws InterruptedException{
		...
		WebElement nextBtn = driver.findElement(By.xpath("//div[@id='payment-next-button']/input"));
	...
	public void clickOnSetupCRPAccountBtn() throws InterruptedException{
		...
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//ul[@style='cursor: pointer;']/li[2]/div")));
		//driver.click(By.xpath("//input[@value='Setup CRP Account']"));
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//input[@value='ENROL IN CRP'] | //input[@value='Setup CRP Account']")));
		logger.info("Next button on billing profile clicked");
		driver.waitForLoadingImageToDisappear();
	}

	public void clickPlaceOrderBtn()throws InterruptedException{
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.id("placeOrderButton")),"Place Order button");
		driver.waitForLoadingImageToDisappear();
		try{
			switchToPreviousTab();
		}catch(Exception e){
	...
	public void dismissPolicyPopup(){
		try {	
			...
			if (we.isDisplayed()){
				...
				logger.info("Policy Popup Dialog is seen.");
				driver.waitForLoadingImageToDisappear();
			}
			//do nothing
		}
	...
	public void applyPriceFilterLowToHigh() throws InterruptedException{
		...
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//select[@id='sortOptions']")));
	...
	public void clickOnAllowMySpouseOrDomesticPartnerCheckbox() {
		  ...
		  try{
		   driver.click(By.xpath("//input[@id='spouse-check']/.."), "Allow spouse checkbox");
		   }
		  catch(Exception e){
	...
	public boolean isRequestSponsorLinkPresent(){
		try{
			driver.turnOffImplicitWaits();
			driver.isElementVisible(By.xpath("//*[@value='Request a sponsor or @id='requestsponsor'])"));
			return true;
		}catch(Exception e){
			return false;
		}finally{
	...
	public void clickYesIWantToJoinPCPerksCB(){
		...
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.id("pc-customer2-div-order-summary")));
		driver.waitForPageLoad();
	}
	...
	public boolean validatePulseHomePage(){
		...
		try{		
			wait.until(ExpectedConditions.urlContains("pulse"));
		}catch(Exception e){
			wait.until(ExpectedConditions.urlContains("laserhead"));
		}
		return driver.getCurrentUrl().toLowerCase().contains("pulse")|| driver.getCurrentUrl().toLowerCase().contains("laserhead");
	}
	...
	public void hoverOnShopLinkAndClickAllProductsLinksAfterLogin(){
		...
		try{
			...
			driver.quickWaitForElementPresent(By.xpath("//div[@id='header']//a[contains(text(),'SHOP SKINCARE')]")); 
			shopSkinCare = driver.findElement(By.xpath("//div[@id='header']//a[contains(text(),'SHOP SKINCARE')]"));
			actions.moveToElement(shopSkinCare).pause(1000).click().build().perform();  
		}catch(Exception e){
			actions = new Actions(RFWebsiteDriver.driver);
			String url=driver.getCurrentUrl();
			if(url.contains(".com") && !(url.contains("corprfo"))){
				driver.waitForElementPresent(By.xpath("//div[@id='header']/following::a[@id='our-products'][1]")); 
				shopSkinCare = driver.findElement(By.xpath("//div[@id='header']/following::a[@id='our-products'][1]"));
				actions.moveToElement(shopSkinCare).pause(1000).click().build().perform();
			}else{
				driver.waitForElementPresent(By.xpath("//div[@id='header']//a[@id='our-products']")); 
				shopSkinCare = driver.findElement(By.xpath("//div[@id='header']//a[@id='our-products']"));
				actions.moveToElement(shopSkinCare).pause(1000).click().build().perform();
			}
	...
	public void clickOnWelcomeDropDown() throws InterruptedException{
		...
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(WELCOME_USER_DD_LOC),"Welcome Dropdown");
	}
	...
	public void clickOnAccountInfoNextButton(){
		...
		driver.clickByJS(RFWebsiteDriver.driver,driver.findElement(By.id("clickNext")));
	} 	
	...
	public void clickAddNewShippingProfileLink() throws InterruptedException{
		driver.quickWaitForElementPresent(By.xpath("//a[contains(text(),'Add new shipping address')]"));
	...
	public void clickOnAddToCRPButtonCreatingCRPUnderBizSite() throws InterruptedException{
		...
		driver.clickByJS(RFWebsiteDriver.driver, By.xpath("//div[@id='main-content']/descendant::*[contains(text(),'ADD TO CRP') or @value='Add to crp'][1]"));
	...
	public StoreFrontAccountInfoPage clickAccountInfoLinkPresentOnWelcomeDropDown() throws InterruptedException{
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//a[text()='Account Info']")),"Account Info link on Welcome DropDown");
		driver.waitForLoadingImageToDisappear();
		driver.pauseExecutionFor(1000);
	...
	public void clickOnAutoshipStatusLink() throws InterruptedException{
...
//	}
	...
	public boolean isYourConsultantPresentWhilePCRCEnrollment(){
		try{
			driver.turnOffImplicitWaits();
			driver.isElementVisible(By.xpath("//*[@id='sponsorInfo']"));
			return true;
		}catch(Exception e){
			return false;
		}finally{
	...
	public void selectNewShippingAddressState(String state){ 
		if(driver.findElements(By.id("state")).size()==1){
			driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.id("state")));
			driver.click(By.xpath(String.format("//*[@id='state']//option[contains(text(),'%s')]", state)));
		}   
		else{
			driver.click(By.xpath("//form[contains(@id,'delivery')]//*[@id='state']"));
			driver.click(By.xpath(String.format("//form[contains(@id,'delivery')]//*[@id='state']//option[contains(text(),'%s')]", state)));
		}
		logger.info("State/Province selected"+state);
	}
	...
	public void clickOnEditShipping(){
		...
		driver.pauseExecutionFor(2000);
		//driver.clickByJS(RFWebsiteDriver.driver,By.xpath("//div[@id='checkout_summary_deliverymode_div']//a"));
	...
	public void selectUseAsEnteredBtnOnQASPopup(){
		try{
			driver.quickWaitForElementPresent(By.xpath("//input[contains(@id,'AcceptOriginal')]"));
			driver.click(By.xpath("//input[contains(@id,'AcceptOriginal')]"));
			logger.info("Accept New shipping address button clicked");
	...
	public void cancelPulseSubscription(){
		driver.waitForElementPresent(By.xpath("//a[contains(text(),'Cancel my Pulse subscription' ) or contains(text(),'Cancel my PULSE Pro subscription')]"));
		driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//a[contains(text(),'Cancel my Pulse subscription' ) or contains(text(),'Cancel my PULSE Pro subscription')]")));
		logger.info("click by js on cancel my pulse subscription button");
		driver.pauseExecutionFor(2000);
		driver.click(By.xpath("//a[@id='cancelPulse']"));
		driver.waitForLoadingImageToDisappear();
		try{
	...
	public void selectNewBillingCardAddress(){
		if(isMobile()){
			...
			driver.clickByJS(RFWebsiteDriver.driver,driver.findElement(By.id("addressBookdropdown")));
			driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//*[@id='addressBookdropdown']/option[1]")));
			logger.info("New Billing card address selected");
		}
	}
	...
	public void clickOnPCPerksTermsAndConditionsCheckBoxes(){
		...
		driver.pauseExecutionFor(1000);
		try{
			driver.clickByJS(RFWebsiteDriver.driver,driver.findElement(By.xpath("//div[@class='content']/li[1]//input/..")));
			driver.clickByJS(RFWebsiteDriver.driver,driver.findElement(By.xpath("//div[@class='content']/li[2]//input/..")));
		}catch(Exception e){
			driver.waitForElementPresent(By.xpath("//input[@id='Terms2']/.."));
			//driver.click(By.xpath("//input[@id='Terms2']/.."));
			driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//input[@id='Terms2']/..")));
	...
	public StoreFrontConsultantPage loginAsConsultant(String username,String password){
		...
		driver.waitForPageLoad();
		driver.pauseExecutionFor(1000);
		if(driver.isElementPresent(LOGIN_LINK_LOC)){
			driver.click(LOGIN_LINK_LOC);
			logger.info("login link clicked");
			logger.info("login username is: "+username);
			logger.info("login password is: "+password);
		...
		try{
			...
			if(renewLater==true){
				...
				if(renewNow==true){
					driver.get(driver.getURL()+"/"+driver.getCountry());
					while(true){
						List<Map<String, Object>> randomRCList = DBUtil.performDatabaseQuery(DBQueries_RFO.callQueryWithArguement(DBQueries_RFO.GET_RANDOM_RC_RFO,countryId),RFO_DB);
