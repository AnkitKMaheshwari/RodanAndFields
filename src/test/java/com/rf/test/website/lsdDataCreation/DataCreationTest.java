...
public class DataCreationTest extends RFWebsiteBaseTest{
	...
	public void testLSDDataCreation() throws InterruptedException{
		...
		storeFrontHomePage.clickOnRodanAndFieldsLogo();
		Assert.assertTrue(storeFrontHomePage.verifyWelcomeDropdownToCheckUserRegistered(), "First PC of L1 is not registered successfully");
		driver.get(driver.getURL()+"/"+country);
		if(storeFrontHomePage.verifyWelcomeDropdownToCheckUserRegistered() == true){
			logout();
		}
		...
		storeFrontHomePage.clickOnRodanAndFieldsLogo();
		Assert.assertTrue(storeFrontHomePage.verifyWelcomeDropdownToCheckUserRegistered(), "User NOT registered successfully");
		driver.get(driver.getURL()+"/"+country);
		if(storeFrontHomePage.verifyWelcomeDropdownToCheckUserRegistered() == true){
			logout();
		}
		...
		/**
		 * LEVEL 2 Tia Knight PC enrollment under Ramone Marine
		 */
		driver.get(driver.getURL()+"/"+country);
		...
		/**
		 * LEVEL 2 Van Kind PC enrollment under Luigi Shalhoub 
		 */
		driver.get(driver.getURL()+"/"+country);
		...
		/**
		 * LEVEL 2 Fred Stanton PC enrollment under Guido Quaroni 
		 */
		driver.get(driver.getURL()+"/"+country);
		...
		/**
		 * LEVEL 2 DJ Holowicki PC enrollment under Harv Clarkson 
		 */
		driver.get(driver.getURL()+"/"+country);
		...
		/**
		 * LEVEL 2 Master Guy PC enrollment under Sally Carrera 
		 */
		driver.get(driver.getURL()+"/"+country);
		...
		/**
		 * LEVEL 2 Doc Hudson PC enrollment under Flo Lewis 
		 */
		driver.get(driver.getURL()+"/"+country);
		...
		/**
		 * LEVEL 2 James Goodwin PC enrollment under Fillmore Carlin 
		 */
		driver.get(driver.getURL()+"/"+country);
		...
		/**
		 * LEVEL 2 Boost Rivera PC enrollment under Mack Crystal 
		 */
		driver.get(driver.getURL()+"/"+country);
