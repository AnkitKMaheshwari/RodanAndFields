...
public class OrderTabTest extends RFNSCoreWebsiteBaseTest{
	...
	@Test 
	public void testPaymentErrorMessageNSC3_1943(){
		String emailID = null;
		String accountNumber = null;
		String firstName=null;
		String lastName=null;
		...
		String autoshipOrderType = "Consultant";
		String category="Name";
		String errorMsg="Failed! This transaction has been declined due to an invalid account number";
		List<Map<String, Object>> randomConsultantList =  null;
		RFL_DB = driver.getDBNameRFL();
		NSCore4HomePage nscore4HomePage = new NSCore4HomePage(driver);
		nscore3LoginPage = new NSCore3LoginPage(driver);
		nscore3HomePage = new NSCore3HomePage(driver);
		randomConsultantList = DBUtil.performDatabaseQuery(DBQueries_RFL.GET_RANDOM_ACTIVE_CONSULTANT_WITH_ORDERS_AND_AUTOSHIPS_RFL,RFL_DB);	
		...
		lastName = (String) getValueFromQueryResult(randomConsultantList, "LastName");	
		customerName = firstName.trim() +" "+ lastName.trim();
		//Navigating to NSCore4
		driver.get("https://nsc4rfo."+driver.getEnvironment()+".rodanandfields.com");
		login("admin", "skin123!");
		...
		nscore4HomePage.editBillingDetails(TestConstantsRFL.INVALID_CARD_NUMBER, TestConstantsRFL.SECURITY_CODE);
		nscore4HomePage.clickSaveTemplate();
		//Navigating to NSCore3
		...
		nscore3HomePage.selectRunCheckbox(accountNumber);
		nscore3HomePage.runAutoshipOrder();
		s_assert.assertTrue(nscore3HomePage.getFailedTemplateMessage().contains(errorMsg),"Failed! This transaction has been declined due to an invalid account number. message not visible");
		s_assert.assertAll();
	}
