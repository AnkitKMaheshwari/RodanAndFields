...
public class HomePageFunctionalityTest extends RFWebsiteBaseTest{
	...
	public void testJoinMyTeamButtonPresentOnTheComAndBizSite_4350(){
		...
		s_assert.assertTrue(driver.getCurrentUrl().contains(".biz/"+country+"/consultant/enrollment/kitproduct"),"user is not on biz enrollment kit page after clicking 'Join My Team' btn");
