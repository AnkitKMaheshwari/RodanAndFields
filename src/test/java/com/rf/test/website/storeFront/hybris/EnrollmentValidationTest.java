...
//		//Click on Check out
//		storeFrontHomePage.clickOnCheckoutButton();
//		rcUserEmailID = firstName+TestConstants.EMAIL_ADDRESS_SUFFIX;
//		//Enter the User information and DO NOT check the "Become a Preferred Customer" checkbox and click the create account button
...
//		//Click on Check out
//		storeFrontHomePage.clickOnCheckoutButtonAfterAddProduct();
//		PCUserEmailID = firstName+TestConstants.EMAIL_ADDRESS_SUFFIX;
//		//Enter the User information and DO NOT check the "Become a Preferred Customer" checkbox and click the create account button
...
//
//			//Enter the User information and DO NOT check the "Become a Preferred Customer" checkbox and click the create account button
//			String rcEmailAddress = firstNameRC+TestConstants.EMAIL_ADDRESS_SUFFIX;
...
//	/**login by: Consultant
//	 * Validations: 
//	 * Register as RC with Cross Country Sponsor WITH Pulse
...
//		s_assert.assertTrue(storeFrontHomePage.validateExistingUserPopUp(pcmailId),"Existing PC user pop-up is not displayed!!");
...
//		s_assert.assertTrue(storeFrontHomePage.validateExistingUserPopUp(rcmailId),"Existing user RC pop-up is not displayed!!");
//		//click close on the Pop-up
//		storeFrontHomePage.clickCloseOnExistingUserPopUp();
//		s_assert.assertAll(); 
//	}
