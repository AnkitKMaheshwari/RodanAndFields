...
public class CRMRegressionTest extends RFCRMWebsiteBaseTest{
	...
	public void testEditPreferredCustomerActDetails_4507() throws InterruptedException	{
		...
		String locale = TestConstants.CRM_NEW_LOCALE_CA;
		String region = TestConstants.CRM_NEW_REGION_CA;
		s_assert.assertTrue(crmHomePage.verifyHomePage(),"Home page does not come after login");
		...
		crmAccountDetailsPage.editAddressFieldsOfMainAddressSection("City", locale);
		crmAccountDetailsPage.editAddressFieldsOfMainAddressSection("State/Province", region);
	...
	public void testEditPreferredCustomerContactDetails_4508() throws InterruptedException {
		...
		crmContactDetailsPage.updateEmailField(consultantEmailID);
		crmContactDetailsPage.clickSaveBtnUnderAccountDetail();
	...
	@Test(enabled=false, priority=34)// Functionality no longer valid 
	...
	public void testChangeDefaultRCShippingAddress_4621() throws InterruptedException{
		...
		crmAccountDetailsPage.clickEditOfNonDefaultShippingProfile();
		crmAccountDetailsPage.clickCheckBoxForDefaultShippingProfileIfCheckBoxNotSelected();
		crmAccountDetailsPage.clickSaveBtnAfterEditShippingAddress();
		crmAccountDetailsPage.selectUserEnteredAddress();
		crmAccountDetailsPage.clickSaveBtnAfterEditShippingAddress();
		...
		crmHomePage.clickAnyTypeOfActiveCustomerInSearchResult("Retail Customer");
		String profileNameAfterEdit = crmAccountDetailsPage.getDefaultSelectedShippingAddressName();
		s_assert.assertTrue(profileNameAfterEdit.contains(shippingProfileFirstName), "Expected shipping profile name is "+shippingProfileFirstName+"Actual on UI "+profileNameAfterEdit);
		s_assert.assertAll();
	}
	...
	public void testConsultantDetailViewPage_4546() throws InterruptedException{
		...
		s_assert.assertTrue(crmAccountDetailsPage.isConsultantDetailsHighlightPanelDisplayed("Recognized Title"),"Recognition Title field not present in Highlight panel");
	...
	public void testForgotPasswordForConsultant_5004() throws InterruptedException{
		...
		s_assert.assertTrue(pageSource.contains("successfully"),"Email for new password has not been sent");
		s_assert.assertAll();
	}
